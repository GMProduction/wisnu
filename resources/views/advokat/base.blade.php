        ...
        <div class="navbar-inner">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " id="profil" href="/advokat/profil">
...
{{--                    <li class="nav-item">--}}
{{--                        <a class="nav-link " id="kasus" href="/advokat/kasus">--}}
...
{{--                    </li>--}}
                    ...
                    <li class="nav-item">
                        <a class="nav-link " id="jadwal" href="/advokat/jadwal">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " id="konsultasi" href="/advokat/konsultasi">
