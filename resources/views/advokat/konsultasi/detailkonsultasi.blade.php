                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-12 text-right mb-2">
                            <a class="btn btn-sm btn-danger text-white" onclick="modalKonsultasi()">Tambah Konsultasi</a>
                        </div>
                            ...
                            <table id="tabel" class="table align-items-center table-flush">
                                ...
                                @forelse($kasus->konsultasi as $v)
                                    <tr>
                                        ...
                                        <td><a class="btn btn-sm" id="edit" data-id="{{$v->id}}" data-proses="{{$v->proses_konsultasi}}" data-detail="{{$v->detail_konsultasi}}">Edit</a></td>
                                    </tr>
                                @empty
                                    <tr>
                        ...
                        <div class="col-12 text-right">
                            <a href="/advokat/konsultasi" class="btn btn-lg btn-primary">Back</a>
                        </div>
                    </div>
                </div>
            </div>
